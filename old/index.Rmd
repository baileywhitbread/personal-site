...
I am an Australian graduate student in mathematics. My CV is [here](files/CV.pdf). My GitHub is [here](https://github.com/baileywhitbread). 
...
My masters thesis is about the [Arithmetic Geometry of Character Varieties](files/24_mphil_thesis.pdf).

I am developing a [package](https://github.com/baileywhitbread/CharacterVarieties.jl) for Julia to calculate polynomials describing the geometry of character varieties.

I created a poster about the [Topology of Representation Spaces via Arithmetic](files/23_poster.pdf).

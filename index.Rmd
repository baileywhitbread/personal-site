...
I am an Australian graduate student in mathematics. My CV is [here](files/CV.pdf) and my GitHub is [here](https://github.com/baileywhitbread). 
...
I am interested in representation theory, geometry, and computational mathematics.

I like to use the [Chevie package](https://jmichel7.github.io/Chevie.jl/) for Julia.

My masters thesis was about the [Arithmetic Geometry of Character Varieties](files/24_mphil_thesis.pdf).

For a visual explanation, I created a poster about the [Topology of Representation Spaces via Arithmetic](files/23_poster.pdf).

My undergraduate thesis was about [Hecke Algebras and Gelfand Pairs in Representation Theory](files/21_honours_thesis.pdf).
...
-   I play Tetris.
    ...
    -   [NES Tetris](files/tetris.nes) (right-click -\> 'Save as...'-\> tetris.nes, play this file with [Mesen](https://www.mesen.ca/))
    -   A bad [time](https://tetr.io/#r:61b440fd551f6403891aab5c) and a bad [score](files/24_nes_L15.png).
-   I played [Geoguessr 10 seconds no moving, panning or zooming](https://www.geoguessr.com/results/VKSszaWqFh68td7r).
